...
**v-ui** — 一个基于网页的高级开源控制面板，专为管理 Xray-core 服务器而设计。它提供了用户友好的界面，用于配置和监控各种 VPN 和代理协议。

> [!IMPORTANT]
> 本项目仅用于个人使用和通信，请勿将其用于非法目的，请勿在生产环境中使用。

作为原始 V-UI 项目的增强版本，v-ui 提供了更好的稳定性、更广泛的协议支持和额外的功能。
...
完整文档请参阅 [项目Wiki](https://github.com/newnewsposes/v-ui/wiki)。
